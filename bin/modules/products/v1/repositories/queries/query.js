...
const listProduct = async (params) => {
  ...
  const query = `SELECT products.*, categories.name as category FROM products LEFT JOIN categories ON products.category_id = categories.id ORDER BY create_at DESC`;
